...
CREATE TABLE `composizioneordine` (
  ...
  CONSTRAINT `composizioneOrdine_ordine_numOrdineProgessivo_fk` FOREIGN KEY (`ordine`, `cliente`) REFERENCES `ordine` (`numOrdineProgressivo`, `cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `composizioneordine` VALUES (1,'GBasile','4X6AYOAF',1,5.99),(1,'GBasile','7P6TAKI9P',1,3.27),(1,'GBasile','BEFJ201',1,2.99),(2,'GBasile','BLUEF234',4,2.50),(2,'GBasile','hcCcRJX5',1,5.99),(2,'GBasile','MElE578',1,6.99),(2,'GBasile','MONST03',1,6.99),(3,'GBasile','DORC189',1,3.49),(3,'GBasile','gBHM8710J',1,2.49),(3,'GBasile','JERKW23',1,4.99),(3,'GBasile','JgrrTR876',1,6.99),(4,'LMiranda','T4iGqTCG',1,6.50),(4,'LMiranda','t6hyM8710J',1,4.00),(4,'LMiranda','UoESj9xK',1,3.90),(5,'LMiranda','gBHM8710J',1,2.49),(5,'LMiranda','GesKKqnx',1,6.00),(5,'LMiranda','JgrrTR876',1,6.99),(5,'LMiranda','MElE578',1,6.99),(6,'CTroiano','OCNG762',1,2.99),(6,'CTroiano','Pz7nszym',1,2.49),(6,'CTroiano','PZzimtRa',1,1.99),(7,'LMiranda','4X6AYOAF',1,5.99),(7,'LMiranda','7P6TAKI9P',1,3.27),(7,'LMiranda','BEFJ201',1,2.99),(7,'LMiranda','BLUEF234',1,2.50),(8,'LMiranda','Pz7nszym',1,2.49),(8,'LMiranda','PZzimtRa',1,1.99),(8,'LMiranda','t6hyM8710J',1,4.00),(9,'GBasile','Pz7nszym',1,2.49),(9,'GBasile','PZzimtRa',1,1.99),(10,'GBasile','OCNG762',1,2.99),(10,'GBasile','t6hyM8710J',1,4.00);
...
INSERT INTO `ordine` VALUES (1,'GBasile','IBAN','IT84G0300203280397435493853','null','Nola','80035','Via San Simone','289','Napoli','Italia','2022-07-14',17.25),(2,'GBasile','IBAN','IT84G0300203280397435493853','null','Nola','80035','Via San Simone','289','Napoli','Italia','2022-07-14',34.97),(3,'GBasile','IBAN','IT84G0300203280397435493853','null','Nola','80035','Via San Simone','289','Napoli','Italia','2022-07-14',22.96),(4,'LMiranda','carta','null','5111538754725418','Nola','80035','Via Franco Civetta','17','Napoli','Italia','2022-07-14',19.4),(5,'LMiranda','IBAN','IT22T0300203280284125425667','null','San Giuseppe Vesuviano','80047','Via Giacomo Leopardi','69','Napoli','Italia','2022-07-14',27.47),(6,'CTroiano','IBAN','IT14U0300203280955173519725','null','Portico di Caserta','81050','Via Trieste','45','Caserta','Italia','2022-07-14',12.47),(7,'LMiranda','carta','null','5111538754725418','San Giuseppe Vesuviano','80047','Via Giacomo Leopardi','69','Napoli','Italia','2022-07-14',19.75),(8,'LMiranda','IBAN','IT22T0300203280284125425667','null','San Giuseppe Vesuviano','80047','Via Giacomo Leopardi','69','Napoli','Italia','2022-07-14',13.48),(9,'GBasile','IBAN','IT84G0300203280397435493853','null','Nola','80035','Via San Simone','289','Napoli','Italia','2022-07-14',9.48),(10,'GBasile','IBAN','IT84G0300203280397435493853','null','Nola','80035','Via San Simone','289','Napoli','Italia','2022-07-14',11.99);
...
INSERT INTO `recensione` VALUES ('CTroiano','OCNG762','Ocean Bomb Goku Arancia',4,'Unico nel suo genere','2022-07-14',0),('CTroiano','Pz7nszym','Snickers Almond',4,'Squisito ','2022-07-14',0),('CTroiano','PZzimtRa','Reese\'s Nut Bar',4,'Molto buono','2022-07-14',1),('GBasile','4X6AYOAF','Dorayaki Color',3,'Buone','2022-07-14',0),('GBasile','7P6TAKI9P','Baumkuchen Torta Al Latte E Fragola',2,'Buona ma per il prezzo non ne vale la pena!','2022-07-14',1),('GBasile','BEFJ201','Jack Link\'s Beef Jerky Original',5,'Buonissime','2022-07-14',0),('GBasile','BLUEF234','Fanta Berry-Mirtillo e Lampone',5,'Davvero un gusto sublime, sono daccordo con LMiranda!','2022-07-14',1),('GBasile','gBHM8710J','Chocolate Pocky',4,'Piacciono molto a mio figlio, le comprero\' ancora','2022-07-14',0),('GBasile','OCNG762','Ocean Bomb Goku Arancia',5,'Ho sentito proprio il gusto del super sayan, bevanda buonissima!','2022-07-14',1),('GBasile','Pz7nszym','Snickers Almond',1,'Sono amante delle mandorle ma questo snack mi ha deluso molto!','2022-07-14',1),('GBasile','PZzimtRa','Reese\'s Nut Bar',5,'Il nome non smentisce mai, il prezzo e\' ottimo anche la consegna affidabilissima e ovviamente sapore unico! ','2022-07-14',0),('GBasile','t6hyM8710J','Pop Tarts Frosted Cookies and Creme',5,'Ho preso questa edizione limitata in offerta davvero buoni, sono contentissimo!','2022-07-14',0),('LMiranda','4X6AYOAF','Dorayaki Color',4,'Hanno soddisfatto i miei gusti','2022-07-14',0),('LMiranda','7P6TAKI9P','Baumkuchen Torta Al Latte E Fragola',2,'Mi aspettavo di meglio','2022-07-14',1),('LMiranda','BEFJ201','Jack Link\'s Beef Jerky Original',5,'Non ho mai provato niente di cosi delizioso','2022-07-14',0),('LMiranda','BLUEF234','Fanta Berry-Mirtillo e Lampone',5,'Buonissima non la trovavo da nessuna parte, siete gli unici a venderla! \r\nContinuate cosi\'!','2022-07-14',0),('LMiranda','gBHM8710J','Chocolate Pocky',3,'Non vale la candela!','2022-07-14',1),('LMiranda','Pz7nszym','Snickers Almond',4,'Davvero unico nel sapore','2022-07-14',0),('LMiranda','PZzimtRa','Reese\'s Nut Bar',4,'Buonissime','2022-07-14',1),('LMiranda','t6hyM8710J','Pop Tarts Frosted Cookies and Creme',5,'Non smettero\' mai di comprarlo, il mio snack preferito!','2022-07-14',0);
...
-- Dump completed on 2022-07-14 17:06:44
