...
CREATE TABLE `recensione` (
  ...
  KEY `fk_recensione_2_idx` (`prodotto`),
  CONSTRAINT `fk_recensione_1` FOREIGN KEY (`cliente`) REFERENCES `utente` (`username`),
  CONSTRAINT `fk_recensione_2` FOREIGN KEY (`prodotto`) REFERENCES `prodotto` (`codiceSeriale`),
...
-- Dump completed on 2022-06-18 15:54:25
