...
CREATE TABLE `composizioneordine` (
  ...
  CONSTRAINT `composizioneOrdine_ordine_numOrdineProgessivo_fk` FOREIGN KEY (`ordine`, `cliente`) REFERENCES `ordine` (`numOrdineProgressivo`, `cliente`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `indirizzo` (
  ...
  CONSTRAINT `indirizzo_utente_username_fk` FOREIGN KEY (`utente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `metododipagamento` (
  ...
  CONSTRAINT `metodoDiPagamento_utente_username_fk` FOREIGN KEY (`utente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `ordine` (
  ...
  CONSTRAINT `ordine_utente_username_fk` FOREIGN KEY (`cliente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `recensione` (
  ...
  CONSTRAINT `fk_recensione_1` FOREIGN KEY (`cliente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO `recensione` VALUES ('CTroiano','4X6AYOAF','Dorayaki Color',1,'Non mi e\' piaciuto per nulla','2022-06-24',0),('CTroiano','7P6TAKI9P','Baumkuchen Torta Al Latte E Fragola',2,'Non lo so quanto siano buoni','2022-06-25',0),('CTroiano','hcCcRJX5','Monster Cuba Libre',3,'Buona dai','2022-06-24',1),('GBasile','4X6AYOAF','Dorayaki Color',2,'Peppino gusta','2022-07-06',0),('GBasile','hcCcRJX5','Monster Cuba Libre',4,'A peppino non piace','2022-07-06',1),('LMiranda','4X6AYOAF','Dorayaki Color',4,'e\' molto bello e mi piace tanto pero ci ho ripensato forse mi piace un po meno. Spedizione ultra istantanea spedita con la mente pero mi piaccio comunque','2022-07-07',1),('LMiranda','7P6TAKI9P','Baumkuchen Torta Al Latte E Fragola',5,'Mi piacciono molto i fagioli','2022-06-24',0),('LMiranda','BIFC675','BiFi Carazza ',3,'troppo buoni i bifi carazza uao','2022-07-07',0),('LMiranda','GesKKqnx','Chip Star Potato Chips - Mild Salt',3,'Mi piacevano tanto','2022-06-22',0),('LMiranda','hcCcRJX5','Monster Cuba Libre',1,'non mi piace di nuovo uffa','2022-07-07',0),('LMiranda','t6hyM8710J','Pop Tarts Frosted Cookies and Creme',5,'So troppo buoni i pop tarts, sanno di zucchero e rimpianti','2022-07-07',0);
...
INSERT INTO `utente` VALUES ('ANappi','bmFwcGk5OQ==','anappi@gmail.com','Antonio','Nappi','M',0),('CTroiano','cHJvdmEx','ctroiano@gmail.com','Ciro','Troiano','M',0),('GBasile','YmFzaWxlMjI=','gbasile@gmail.com','Giuseppe','Basile','M',0),('LMessi10','TGlvbmVsMTA=','leomessi@email.it','Lionel','Messi','M',0),('LMiranda','bWlyYW5kYTY5','lmiranda12@gmail.com','Luigi','Miranda','M',0),('mario','bWFyaW8=','rossi@email.it','mario','rossi','M',0),('root','cm9vdA==','root@email.com','root','sudo','X',1),('utenteA','cGFzc3dvcmQ=','utentea@email.com','nome','cognome','M',0),('xporion64','cHJvdmE=','ciro.troiano@gmail.com','succa','suchello','M',0);
...
-- Dump completed on 2022-07-16 11:55:20
